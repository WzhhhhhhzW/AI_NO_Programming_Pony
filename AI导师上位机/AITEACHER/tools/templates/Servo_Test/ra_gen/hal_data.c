...
gpt_instance_ctrl_t Tail_ctrl;
#if 0
const gpt_extended_pwm_cfg_t Tail_pwm_extend =
{
...
#endif
const gpt_extended_cfg_t Tail_extend =
        { .gtioca =
...
const timer_cfg_t Tail_cfg =
{ .mode = TIMER_MODE_PERIODIC,
/* Actual period: 0.02 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xf424,
  .duty_cycle_counts = 0x7a12, .source_div = (timer_source_div_t) 4, .channel = 4, .p_callback = NULL,
...
const timer_instance_t Tail =
{ .p_ctrl = &Tail_ctrl, .p_cfg = &Tail_cfg, .p_api = &g_timer_on_gpt };
